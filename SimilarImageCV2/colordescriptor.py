...
class ColorDescriptor:
    ...
    def describe(self,image):
        #convert image to HSV color space and initialise
        #features used to quantify the image
        ...
        #divide image into four rectangles/segments (top-left,top-right,bottom-right,bottom-left)
        ...
        for(startX,endX,startY,endY) in segments:
            #construct a mask for each corner of the image, substracting the elliptical center from it
